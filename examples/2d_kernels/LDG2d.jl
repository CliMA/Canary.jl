...
# ```
#
# Equation (7) represents the approximation of the divergence operator on the vector $\mathbf{Q}$ where the first term on the right denotes the flux integral (computed in "function flux\_div") and the second term on the right denotes the volume integral term (computed in "function volume\_div").
#-
# ## Commented Program
#
#--------------------------------Markdown Language Header-----------------------
...
# {{{ LDG driver
function LDG(::Val{dim}, ::Val{N}, mpicomm, ic, mesh, tend, gravity, δnl,
