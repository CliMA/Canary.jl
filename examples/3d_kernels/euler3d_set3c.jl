...
# Face RHS for 3D
function facerhs!(::Val{3}, ::Val{N}, rhs::Array, Q, sgeo, vgeo, elems, vmapM,
...
@hascuda function knl_facerhs!(::Val{dim}, ::Val{N}, rhs, Q, sgeo, vgeo, nelem, vmapM,
...
function main()
  ...
  if hardware == "cpu"
     ...
     euler(Val(dim), Val(N), mpicomm, (x...)->ic(dim, x...), mesh3D, time_final, iplot;
